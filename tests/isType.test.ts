...
describe("is empty type", () => {
	describedGuardTests({
		...
		testCases: [
			...
			[12, true, { zod: "inverted" }],
			[12n, true, { zod: "inverted" }],
			[true, true, { zod: "inverted" }],
			[false, true, { zod: "inverted" }],
			[Symbol(), true, { zod: "inverted" }],
			["vsfbsdf", true, { zod: "inverted" }],
			[{}, true],
			[[], true, { zod: "inverted" }],
			[[12, () => {}, "string"], true, { zod: "inverted" }],
			[new Map(), true],
			[new Set(), true],
			[new String(), true],
			[new Date(), true],
...
describe("is tuple like type", () => {
	...
	describedGuardTests({
		...
		testCases: [
			...
			[new Set(), false],
			[{ 0: "Hello", 1: 6 }, true],
			[["Hello", 6], true, { zod: "inverted" }],
			[["Bye", 7, new Date()], true, { zod: "inverted" }],
